...
*   **LK-algoritmi ei noudata aikarajaa:** Kun tietokone jätetään yksi laskemaan tsp-ratkaisua, ei algoritmin suoritus pysähdy aikarajaan. Ongelma voi liittyä tietokoneen energiansäästö- tai lepotilaan, sillä algoritmi noudataa tiukasti aikarajaa, kun kone on aktiivisessa käytössä. Mahdollisia ratkaisuja on energiansäästö- tai lepotilan estäminen tai mahdollisesti `time()`-funktion korvaamisella `monotonictime()`-funktiolla.  

...
*   **LK-algoritmi ei noudata aikarajaa:** Kun tietokone jätetään yksin laskemaan tsp-ratkaisua, ei algoritmin suoritus aina pysähdy aikarajaan. Ongelma voi liittyä tietokoneen energiansäästö- tai lepotilaan, sillä algoritmi noudataa tiukasti aikarajaa, kun kone on aktiivisessa käytössä. Mahdollisia ratkaisuja on energiansäästö- tai lepotilan estäminen tai mahdollisesti `time()`-funktion korvaamisella `time.monotonic()`-funktiolla.  
